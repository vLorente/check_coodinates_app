# Guía de Angular 21 - Convenciones del Proyecto

## 📋 Resumen

Este documento define las convenciones específicas de **Angular 21** que seguiremos en el proyecto. Angular 21 introduce cambios importantes, especialmente el uso de **signals** como mecanismo principal de gestión de estado.
---
